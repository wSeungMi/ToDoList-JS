...
<a href="https://wseungmi.github.io/ToDoList-JS/" target="_blank">
...
- 새로고침을 해도 id 값의 순서가 이어지는 것을 확인할 수 있습니다. 하지만 마지막 데이터를 삭제하는 경우 문제가 있었습니다. 다시 새로운 할 일을 추가했을 때 삭제된 데이터 id의 다음 값이 아닌 방금 삭제했던 데이터의 id 값이 다시 재사용됩니다. 이는 예상치 못한 결과를 초래할 수 있으며, 예측하기 쉬운 id를 사용하는 것은 보안상의 위험을 증가시킬 수 있습니다.
